...
/*   Updated: 2026/02/23 13:36:51 by alemonto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//__________    PARSER.C
t_ast		*parser(t_token **ptokens, t_data *data);
void		set_parser_error(t_parser_context *ctx,
				const char *message, t_token *token);
void		ctx_init(t_parser_context *ctx, t_data *data);
...
char		*get_redir_file(int type, char *text, int quoted, t_data *data);
...
//____________BUILTIN_ECXIT_HELPERS.C
