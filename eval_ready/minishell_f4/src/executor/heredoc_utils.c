...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/23 11:20:11 by jadelgad          #+#    #+#             */
/*   Updated: 2026/02/23 11:23:15 by jadelgad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	process_and_write_heredoc_line(int fd, char *line,
...
int	write_heredoc_loop(int fd, char *delimiter, int quoted, t_data *data)
{
	...
	while (1)
	{
		...
		process_and_write_heredoc_line(fd, line, quoted, data);
		free(line);
	}
	setup_signals();
	return (status);
